  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6 flex flex-col">
      ...
      <div className="flex justify-between items-center mb-8">
        ...
        <button
          onClick={onBack}
          className="px-5 py-2 text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-all duration-200"
        >
          Back
        </button>
      </div>
      ...
      <div className="flex-1 flex flex-col lg:flex-row gap-8">
        {/* Image Preview */}
        <div className="lg:w-1/2 bg-white rounded-xl overflow-hidden">
        ...
        <div className="lg:w-1/2 flex flex-col gap-6">
          {/* Pre-Analysis State */}
          {!isAnalyzing && !result && (
            <div className="flex-1 flex flex-col items-center justify-center bg-white rounded-xl p-8">
              <p className="text-gray-600 text-lg mb-6 font-medium">Ready to analyze your image</p>
              <button
                onClick={handleAnalyze}
          ...
          {result && (
            <div className="flex-1 flex flex-col">
              ...
              >
                ...
                <div className="mb-6">
                  <p className="font-medium text-gray-700 mb-2">Confidence Score:</p>
                  ...
                  <p className="text-right text-sm text-gray-600 mt-1">{result.confidence}%</p>
                </div>

                <div>
                  <p className="font-medium text-gray-700 mb-2">Analysis Details:</p>
              ...
              <div className="flex gap-4 mt-6">
                <button
                  onClick={onBack}
                  className="flex-1 px-6 py-3 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-50 transition-all duration-200"
                >
                  Back
                </button>
                <button
                  onClick={onReset}
                  className="flex-1 px-6 py-3 bg-gray-800 text-white rounded-lg shadow-md hover:bg-gray-900 transition-all duration-200"
                >
                  New Analysis
                </button>
              </div>
